...
void DrawCriticalPoints(const Renderer& renderer, const HBDebugData& data, const Camera& camera, int w, int h) {
...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        if (showSaddlePoints && selectedBspline) {
            DrawCriticalPoints(renderer, hbDebugData, state.camera, w, h);
        }
